...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* ─── 3. BAUNFIRE-STYLE FULL-SCREEN MENU OVERLAY WITH GPU BUBBLE EFFECT ─── */}
      <AnimatePresence>
        {isMenuOpen && (
          <div className="fixed inset-0 z-[100] overflow-hidden pointer-events-auto">
            {/* 1. GPU Expanding Bubble Background (scales seamlessly from button origin) */}
            <motion.div
              style={{
                position: 'fixed',
                left: bubbleOrigin.x,
            ...
            {/* 2. Leading Glowing Lime Shockwave Wave */}
            <motion.div
              style={{
                position: 'fixed',
                left: bubbleOrigin.x,
